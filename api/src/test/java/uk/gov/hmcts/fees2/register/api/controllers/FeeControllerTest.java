...
public class FeeControllerTest extends BaseIntegrationTest {
    ...
    public synchronized void feesLookupTest() throws Exception {
        ...
        restActions
            .get("/fees-register/fees/lookup?service=divorce&jurisdiction1=family&jurisdiction2=high court&event=copies&channel=online&amount_or_volume=311&application=all")
            .andExpect(status().isOk())
    ...
    public synchronized void feesLookupNotFoundTest() throws Exception {
        restActions
            .get("/fees-register/fees/lookup?service=divorce&jurisdiction1=family&jurisdiction2=high court&event=copies&amount_or_volume=10&channel=default&application=all")
