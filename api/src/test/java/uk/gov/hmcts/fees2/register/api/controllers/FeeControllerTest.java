...
import uk.gov.hmcts.fees2.register.api.controllers.advice.FeesControllerAdvice;
...
public class FeeControllerTest extends BaseIntegrationTest {
    ...
    public synchronized void createCsvImportFixedFeesTest() throws Exception {
        restActions
            .withUser("admin")
            .post("/fees-register/fixedfees", getFixedFeesDto())
            .andExpect(status().isCreated());
    ...
    public synchronized void createCsvImportFixedFeesWithIncorrectDataTest() throws Exception {
        ...
        restActions
            .withUser("admin")
            .post("/fees-register/fixedfees", getIncorrectFixedFeesDto())
