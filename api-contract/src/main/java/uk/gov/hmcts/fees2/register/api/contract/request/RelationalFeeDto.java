...
public class RelationalFeeDto extends FixedFeeDto {
    ...
    public RelationalFeeDto(String code, String newCode, FeeVersionDto version, String jurisdiction1, String jurisdiction2, String service, String channel, String event, String applicantType, boolean unspecifiedClaimAmount) {
