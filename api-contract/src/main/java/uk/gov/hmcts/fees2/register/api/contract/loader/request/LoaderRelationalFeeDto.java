...
public class LoaderRelationalFeeDto extends LoaderFeeDto {
    ...
    public LoaderRelationalFeeDto(String code, String newCode, LoaderFeeVersionDto version, String jurisdiction1, String jurisdiction2, String service, String channel, String event, String applicantType, boolean unspecifiedClaimAmount, String keyword) {
